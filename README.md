...
genbank-processor pipeline -i raw\_data.txt -t genomes.tsv -o downloads/ --delay 1.0 --retries 3
...
2\. GENBANK\_LANG environment variable
...
genbank-processor filter -i raw\_data.txt -o complete\_genomes.txt



\# Convert to TSV format

genbank-processor convert -i complete\_genomes.txt -o genomes.tsv



\# Download GenBank files

genbank-processor download -i genomes.tsv -o gb\_files/ --delay 2.0
...
genbank-processor pipeline -i raw\_data.txt -o results/ -t intermediate.tsv --delay 1.5 --retries 5 -v
